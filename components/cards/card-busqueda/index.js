  ...
  return (
    <div className={`${styles.cardBusqueda} mb-4`}>
      <Link href={`/actividades-y-turismo/${item.slugTour}`}>
        <div
          className={`${styles.cardBusqueda_imagen} mb-4 pointer`}
          style={{
            backgroundImage: "url(" + item.imagenPrincipalTour?.url + ")",
          }}
        ></div>
      </Link>
      ...
      <div className="card-busqueda__contenido d-flex flex-column justify-content-between py-3 px-4">
        ...
        <p className="text-secondary my-0">{item?.descripcionLargaTour}</p>
        ...
        <div className="d-flex justify-content-between align-items-end">
          ...
          <div className="text-right">
            ...
            <h3 className="text-blue font-weight-bold my-0">
